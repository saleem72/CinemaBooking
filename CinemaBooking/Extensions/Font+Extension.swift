...
enum FontType: String, Identifiable, CaseIterable {
    ...
    var fontName: String {
        ...
        case .body, .subheadline, .footnote, .caption, .callout: return "Poppins-Regular"
        case .headline, .caption2: return "Poppins-SemiBold"
        }
    }
}
...
extension View {
    func customFont(_ type: FontType = .body) -> some View {
